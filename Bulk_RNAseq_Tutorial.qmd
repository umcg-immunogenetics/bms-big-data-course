...
author: "Nathan V Ribeiro - <n.v.ribeiro@umcg.nl>"
...
You can visualize the results in many different ways, [check the documentation](https://yulab-smu.top/biomedical-knowledge-mining-book/enrichplot.html) of this package to see all options. For simplicity, we will plot only the dot plot here but explore other ways to visualize in your own analysis.
