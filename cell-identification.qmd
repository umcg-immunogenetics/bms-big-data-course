...
After completing the cell type classification with CellTypist, you should know which seurat clusters correspond to which cell types. You can now go back to R and add the cell type annotation like we did in the [tutorial](http://localhost:5333/scRNA-seq.html#identifying-the-clusters){target="_blank"}.